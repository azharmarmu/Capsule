...
public class UploadPrescriptionActivity extends AppCompatActivity
    ...
    public void continuePrescription(View view) {
        if (photosList.size() > 0)
            ...
            DialogUtils.appToastShort(this, "Please upload prescription to continue");
    }
        ...
        try {
            if (resultCode == Activity.RESULT_OK) {
                if (requestCode == Constants.REQUEST_CAMERA) {
                    ...
                    Uri uri = CommonUtil.getImageUri(UploadPrescriptionActivity.this, BitmapFactory.decodeStream(imageStream));
                    addPhoto(Objects.requireNonNull(uri).toString());
                }
            }
